...
save_pickle("vanilla24_xtrain", X_train)
save_pickle("vanilla24_xtest", X_test)
save_pickle("vanilla24_ytrain", y_train)
save_pickle("vanilla24_ytest", y_test)
save_pickle("vanilla24_indtrain", ind_train)
save_pickle("vanilla24_indtest", ind_test)
save_pickle("vanilla24_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("vanilla24_xtrain")
# X_test = open_pickle("vanilla24_xtest")
# y_train = open_pickle("vanilla24_ytrain")
# y_test = open_pickle("vanilla24_ytest")
# ind_train = open_pickle("vanilla24_indtrain")
# ind_test = open_pickle("vanilla24_indtest")
# dataset = open_pickle("vanilla24_dataset")
...
vanilla1.save('24vanilla1.keras')
save_pickle('24vanillaHist1', history_vanilla1)
save_pickle('24vanilla1_time', vanilla1_time)
...
vanilla2.save('24vanilla2.keras')
save_pickle('24vanillaHist2', history_vanilla2)
save_pickle('24vanilla2_time', vanilla2_time)
...
vanilla3.save('24vanilla3.keras')
save_pickle('24vanillaHist3', history_vanilla3)
save_pickle('24vanilla3_time', vanilla3_time)
...
vanilla4.save('24vanilla4.keras')
save_pickle('24vanillaHist4', history_vanilla4)
save_pickle('24vanilla4_time', vanilla4_time)
...
vanilla5.save('24vanilla5.keras')
save_pickle('24vanillaHist5', history_vanilla5)
save_pickle('24vanilla5_time', vanilla5_time)
...
vanilla6.save('24vanilla6.keras')
save_pickle('24vanillaHist6', history_vanilla6)
save_pickle('24vanilla6_time', vanilla6_time)
