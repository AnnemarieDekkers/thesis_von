...
# save test_train_split data
save_pickle("gru_xtrain", X_train)
save_pickle("gru_xtest", X_test)
save_pickle("gru_ytrain", y_train)
save_pickle("gru_ytest", y_test)
save_pickle("gru_indtrain", ind_train)
save_pickle("gru_indtest", ind_test)
save_pickle("gru_dataset", dataset)
...
# open saved data
# X_train = open_pickle("gru_xtrain")
# X_test = open_pickle("gru_xtest")
# y_train = open_pickle("gru_ytrain")
# y_test = open_pickle("gru_ytest")
# ind_train = open_pickle("gru_indtrain")
# ind_test = open_pickle("gru_indtest")
# dataset = open_pickle("gru_dataset")
...
gru1_time = end - start
gru1.save('gru1.keras')
save_pickle('gruHist1', history_gru1)
save_pickle('gru1_time', gru1_time)
...
gru2_time = end - start
gru2.save('gru2.keras')
save_pickle('gruHist2', history_gru2)
save_pickle('gru2_time', gru2_time)
...
gru3_time = end - start
gru3.save('gru3.keras')
save_pickle('gruHist3', history_gru3)
save_pickle('gru3_time', gru3_time)
...
gru4_time = end - start
gru4.save('gru4.keras')
save_pickle('gruHist4', history_gru4)
save_pickle('gru4_time', gru4_time)
...
gru5_time = end - start
gru5.save('gru5.keras')
save_pickle('gruHist5', history_gru5)
save_pickle('gru5_time', gru5_time)
...
gru6_time = end - start
gru6.save('gru6.keras')
save_pickle('gruHist6', history_gru6)
save_pickle('gru6_time', gru6_time)