...
save_pickle("bi24_xtrain2", X_train)
save_pickle("bi24_xtest2", X_test)
save_pickle("bi24_ytrain2", y_train)
save_pickle("bi24_ytest2", y_test)
save_pickle("bi24_indtrain2", ind_train)
save_pickle("bi24_indtest2", ind_test)
save_pickle("bi24_dataset2", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("bi24_xtrain2")
# X_test = open_pickle("bi24_xtest2")
# y_train = open_pickle("bi24_ytrain2")
# y_test = open_pickle("bi24_ytest2")
# ind_train = open_pickle("bi24_indtrain2")
# ind_test = open_pickle("bi24_indtest2")
# dataset = open_pickle("bi24_dataset2")
...
bi1_time = end - start
bi1.save('24bi1.keras')
save_pickle('24biHist1', history_bi1)
save_pickle('24bi1_time', bi1_time)
...
bi2_time = end - start
bi2.save('24bi2.keras')
save_pickle('24biHist2', history_bi2)
save_pickle('24bi2_time', bi2_time)
...
bi3_time = end - start
bi3.save('24bi3.keras')
save_pickle('24biHist3', history_bi3)
save_pickle('24bi3_time', bi3_time)
...
bi4_time = end - start
bi4.save('24bi4.keras')
save_pickle('24biHist4', history_bi4)
save_pickle('24bi4_time', bi4_time)
...
bi5_time = end - start
bi5.save('24bi5.keras')
save_pickle('24biHist5', history_bi5)
save_pickle('24bi5_time', bi5_time)
...
bi6_time = end - start
bi6.save('24bi6.keras')
save_pickle('24biHist6', history_bi6)
save_pickle('24bi6_time', bi6_time)