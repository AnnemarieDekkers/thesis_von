...
save_pickle("vanilla12_xtrain", X_train)
save_pickle("vanilla12_xtest", X_test)
save_pickle("vanilla12_ytrain", y_train)
save_pickle("vanilla12_ytest", y_test)
save_pickle("vanilla12_indtrain", ind_train)
save_pickle("vanilla12_indtest", ind_test)
save_pickle("vanilla12_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("vanilla12_xtrain")
# X_test = open_pickle("vanilla12_xtest")
# y_train = open_pickle("vanilla12_ytrain")
# y_test = open_pickle("vanilla12_ytest")
# ind_train = open_pickle("vanilla12_indtrain")
# ind_test = open_pickle("vanilla12_indtest")
# dataset = open_pickle("vanilla12_dataset")
...
vanilla1.save('12vanilla1.keras')
save_pickle('12vanillaHist1', history_vanilla1)
save_pickle('12vanilla1_time', vanilla1_time)
...
vanilla2.save('12vanilla2.keras')
save_pickle('12vanillaHist2', history_vanilla2)
save_pickle('12vanilla2_time', vanilla2_time)
...
vanilla3.save('12vanilla3.keras')
save_pickle('12vanillaHist3', history_vanilla3)
save_pickle('12vanilla3_time', vanilla3_time)
...
vanilla4.save('12vanilla4.keras')
save_pickle('12vanillaHist4', history_vanilla4)
save_pickle('12vanilla4_time', vanilla4_time)
...
vanilla5.save('12vanilla5.keras')
save_pickle('12vanillaHist5', history_vanilla5)
save_pickle('12vanilla5_time', vanilla5_time)
...
vanilla6.save('12vanilla6.keras')
save_pickle('12vanillaHist6', history_vanilla6)
save_pickle('12vanilla6_time', vanilla6_time)