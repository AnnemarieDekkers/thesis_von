...
save_pickle("lstm12_xtrain2", X_train)
save_pickle("lstm12_xtest2", X_test)
save_pickle("lstm12_ytrain2", y_train)
save_pickle("lstm12_ytest2", y_test)
save_pickle("lstm12_indtrain2", ind_train)
save_pickle("lstm12_indtest2", ind_test)
save_pickle("lstm12_dataset2", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("lstm12_xtrain")
# X_test = open_pickle("lstm12_xtest")
# y_train = open_pickle("lstm12_ytrain")
# y_test = open_pickle("lstm12_ytest")
# ind_train = open_pickle("lstm12_indtrain")
# ind_test = open_pickle("lstm12_indtest")
# dataset = open_pickle("lstm12_dataset")
...
lstm1.save('12lstm1.keras')
save_pickle('12lstmHist1', history_lstm1)
save_pickle('12lstm1_time', lstm1_time)
...
lstm2.save('12lstm2.keras')
save_pickle('12lstmHist2', history_lstm2)
save_pickle('12lstm2_time', lstm2_time)
...
lstm3.save('12lstm3.keras')
save_pickle('12lstmHist3', history_lstm3)
save_pickle('12lstm3_time', lstm3_time)
...
lstm4.save('12lstm4.keras')
save_pickle('12lstmHist4', history_lstm4)
save_pickle('12lstm4_time', lstm4_time)
...
lstm5.save('12lstm5.keras')
save_pickle('12lstmHist5', history_lstm5)
save_pickle('12lstm5_time', lstm5_time)
...
lstm6.save('12lstm6.keras')
save_pickle('12lstmHist6', history_lstm6)
save_pickle('12lstm6_time', lstm6_time)
