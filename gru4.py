...
save_pickle("gru4_xtrain", X_train)
save_pickle("gru4_xtest", X_test)
save_pickle("gru4_ytrain", y_train)
save_pickle("gru4_ytest", y_test)
save_pickle("gru4_indtrain", ind_train)
save_pickle("gru4_indtest", ind_test)
save_pickle("gru4_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("gru4_xtrain")
# X_test = open_pickle("gru4_xtest")
# y_train = open_pickle("gru4_ytrain")
# y_test = open_pickle("gru4_ytest")
# ind_train = open_pickle("gru4_indtrain")
# ind_test = open_pickle("gru4_indtest")
# dataset = open_pickle("gru4_dataset")
...
gru1_time = end - start
gru1.save('4gru1.keras')
save_pickle('4gruHist1', history_gru1)
save_pickle('4gru1_time', gru1_time)
...
gru2_time = end - start
gru2.save('4gru2.keras')
save_pickle('4gruHist2', history_gru2)
save_pickle('4gru2_time', gru2_time)
...
gru3_time = end - start
gru3.save('4gru3.keras')
save_pickle('4gruHist3', history_gru3)
save_pickle('4gru3_time', gru3_time)
...
gru4_time = end - start
gru4.save('4gru4.keras')
save_pickle('4gruHist4', history_gru4)
save_pickle('4gru4_time', gru4_time)
...
gru5_time = end - start
gru5.save('4gru5.keras')
save_pickle('4gruHist5', history_gru5)
save_pickle('4gru5_time', gru5_time)
...
gru6_time = end - start
gru6.save('4gru6.keras')
save_pickle('4gruHist6', history_gru6)
save_pickle('4gru6_time', gru6_time)