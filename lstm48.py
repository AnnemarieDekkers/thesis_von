...
save_pickle("lstm_xtrain", X_train)
save_pickle("lstm_xtest", X_test)
save_pickle("lstm_ytrain", y_train)
save_pickle("lstm_ytest", y_test)
save_pickle("lstm_indtrain", ind_train)
save_pickle("lstm_indtest", ind_test)
save_pickle("lstm_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("lstm_xtrain")
# X_test = open_pickle("lstm_xtest")
# y_train = open_pickle("lstm_ytrain")
# y_test = open_pickle("lstm_ytest")
# ind_train = open_pickle("lstm_indtrain")
# ind_test = open_pickle("lstm_indtest")
# dataset = open_pickle("lstm_dataset")
...
save_pickle('lstmHist1', history_lstm1)
save_pickle('lstm1_time', lstm1_time)
...
save_pickle('lstmHist2', history_lstm2)
save_pickle('lstm2_time', lstm2_time)
...
save_pickle('lstmHist3', history_lstm3)
save_pickle('lstm3_time', lstm3_time)
...
lstm4.save('lstm4.keras')
save_pickle('lstmHist4', history_lstm4)
save_pickle('lstm4_time', lstm4_time)
...
lstm5.save('lstm5.keras')
save_pickle('lstmHist5', history_lstm5)
save_pickle('lstm5_time', lstm5_time)
...
lstm6.save('lstm6.keras')
save_pickle('lstmHist6', history_lstm6)
save_pickle('lstm6_time', lstm6_time)