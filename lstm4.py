...
save_pickle("lstm4_xtrain", X_train)
save_pickle("lstm4_xtest", X_test)
save_pickle("lstm4_ytrain", y_train)
save_pickle("lstm4_ytest", y_test)
save_pickle("lstm4_indtrain", ind_train)
save_pickle("lstm4_indtest", ind_test)
save_pickle("lstm4_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("lstm4_xtrain")
# X_test = open_pickle("lstm4_xtest")
# y_train = open_pickle("lstm4_ytrain")
# y_test = open_pickle("lstm4_ytest")
# ind_train = open_pickle("lstm4_indtrain")
# ind_test = open_pickle("lstm4_indtest")
# dataset = open_pickle("lstm4_dataset")
...
lstm1.save('4lstm1.keras')
save_pickle('4lstmHist1', history_lstm1)
save_pickle('4lstm1_time', lstm1_time)
...
lstm2.save('4lstm2.keras')
save_pickle('4lstmHist2', history_lstm2)
save_pickle('4lstm2_time', lstm2_time)
...
lstm3.save('4lstm3.keras')
save_pickle('4lstmHist3', history_lstm3)
save_pickle('4lstm3_time', lstm3_time)
...
lstm4.save('4lstm4.keras')
save_pickle('4lstmHist4', history_lstm4)
save_pickle('4lstm4_time', lstm4_time)
...
lstm5.save('4lstm5.keras')
save_pickle('4lstmHist5', history_lstm5)
save_pickle('4lstm5_time', lstm5_time)
...
lstm6.save('4lstm6.keras')
save_pickle('4lstmHist6', history_lstm6)
save_pickle('4lstm6_time', lstm6_time)
