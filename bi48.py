...
save_pickle("bi_xtrain2", X_train)
save_pickle("bi_xtest2", X_test)
save_pickle("bi_ytrain2", y_train)
save_pickle("bi_ytest2", y_test)
save_pickle("bi_indtrain2", ind_train)
save_pickle("bi_indtest2", ind_test)
save_pickle("bi_dataset2", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("bi_xtrain2")
# X_test = open_pickle("bi_xtest2")
# y_train = open_pickle("bi_ytrain2")
# y_test = open_pickle("bi_ytest2")
# ind_train = open_pickle("bi_indtrain2")
# ind_test = open_pickle("bi_indtest2")
# dataset = open_pickle("bi_dataset2")
...
bi1_time = end - start
bi1.save('bi1.keras')
save_pickle('biHist1', history_bi1)
save_pickle('bi1_time', bi1_time)
...
bi2_time = end - start
bi2.save('bi2.keras')
save_pickle('biHist2', history_bi2)
save_pickle('bi2_time', bi2_time)
...
bi3_time = end - start
bi3.save('bi3.keras')
save_pickle('biHist3', history_bi3)
save_pickle('bi3_time', bi3_time)
...
bi4_time = end - start
bi4.save('bi4.keras')
save_pickle('biHist4', history_bi4)
save_pickle('bi4_time', bi4_time)
...
bi5_time = end - start
bi5.save('bi5.keras')
save_pickle('biHist5', history_bi5)
save_pickle('bi5_time', bi5_time)
...
bi6_time = end - start
bi6.save('bi6.keras')
save_pickle('biHist6', history_bi6)
save_pickle('bi6_time', bi6_time)