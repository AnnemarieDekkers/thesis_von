...
save_pickle("vanilla_xtrain", X_train)
save_pickle("vanilla_xtest", X_test)
save_pickle("vanilla_ytrain", y_train)
save_pickle("vanilla_ytest", y_test)
save_pickle("vanilla_indtrain", ind_train)
save_pickle("vanilla_indtest", ind_test)
save_pickle("vanilla_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("vanilla_xtrain")
# X_test = open_pickle("vanilla_xtest")
# y_train = open_pickle("vanilla_ytrain")
# y_test = open_pickle("vanilla_ytest")
# ind_train = open_pickle("vanilla_indtrain")
# ind_test = open_pickle("vanilla_indtest")
# dataset = open_pickle("vanilla_dataset")
...
vanilla1.save('vanilla1.keras')
save_pickle('vanillaHist1', history_vanilla1)
save_pickle('vanilla1_time', vanilla1_time)
...
vanilla2.save('vanilla2.keras')
save_pickle('vanillaHist2', history_vanilla2)
save_pickle('vanilla2_time', vanilla2_time)
...
vanilla3.save('vanilla3.keras')
save_pickle('vanillaHist3', history_vanilla3)
save_pickle('vanilla3_time', vanilla3_time)
...
vanilla4.save('vanilla4.keras')
save_pickle('vanillaHist4', history_vanilla4)
save_pickle('vanilla4_time', vanilla4_time)
...
vanilla5.save('vanilla5.keras')
save_pickle('vanillaHist5', history_vanilla5)
save_pickle('vanilla5_time', vanilla5_time)

vanilla6 = build_vanilla([1024, 512, 256, 128, 64, 32], 0.0001)
vanilla6.save('vanilla6.keras')
start = time.time()
history_vanilla6 = vanilla6.fit(X_train, y_train, epochs=epochs, batch_size=32, verbose=1)
save_pickle('vanillaHist6', history_vanilla6)
end = time.time()
vanilla6_time = end - start
save_pickle('vanilla6_time', vanilla6_time)