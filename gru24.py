...
save_pickle("gru24_xtrain", X_train)
save_pickle("gru24_xtest", X_test)
save_pickle("gru24_ytrain", y_train)
save_pickle("gru24_ytest", y_test)
save_pickle("gru24_indtrain", ind_train)
save_pickle("gru24_indtest", ind_test)
save_pickle("gru24_dataset", dataset)

def open_pickle(file):
    with open(file, 'rb') as file_pi:
        return pickle.load(file_pi)

# X_train = open_pickle("gru24_xtrain")
# X_test = open_pickle("gru24_xtest")
# y_train = open_pickle("gru24_ytrain")
# y_test = open_pickle("gru24_ytest")
# ind_train = open_pickle("gru24_indtrain")
# ind_test = open_pickle("gru24_indtest")
# dataset = open_pickle("gru24_dataset")
...
gru1_time = end - start
gru1.save('24gru1.keras')
save_pickle('24gruHist1', history_gru1)
save_pickle('24gru1_time', gru1_time)
...
gru2_time = end - start
gru2.save('24gru2.keras')
save_pickle('24gruHist2', history_gru2)
save_pickle('24gru2_time', gru2_time)
...
gru3_time = end - start
gru3.save('24gru3.keras')
save_pickle('24gruHist3', history_gru3)
save_pickle('24gru3_time', gru3_time)
...
gru4_time = end - start
gru4.save('24gru4.keras')
save_pickle('24gruHist4', history_gru4)
save_pickle('24gru4_time', gru4_time)
...
gru5_time = end - start
gru5.save('24gru5.keras')
save_pickle('24gruHist5', history_gru5)
save_pickle('24gru5_time', gru5_time)
...
gru6_time = end - start
gru6.save('24gru6.keras')
save_pickle('24gruHist6', history_gru6)
save_pickle('24gru6_time', gru6_time)
